...
![git status and branching](screenshots/git-branching.png)
...
![git branching](screenshots/git-new-branch.png)
...
![git adding file](screenshots/git-contact.html.png)

---

#### Screenshot 4 — Output of `git commit`

![git committing file](screenshots/git-commit-of-contact.html.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![git committing file](screenshots/git-log-for-contact.html.png)
...
![git modified file](screenshots/git-index.html-modified-in-branching.png)
...
![git modified file](screenshots/git-commit-of-contact.html.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![git index.html in browser](screenshots/git-index.html.website-page.png)
...
![git modified file](screenshots/git-index.html-style.css-files.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![git index file on browser](screenshots/git-index.html-website-no-contact.png)
...
![git merge Output](screenshots/git-merge.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![git contact.html file](screenshots/git-contact.html.png)
